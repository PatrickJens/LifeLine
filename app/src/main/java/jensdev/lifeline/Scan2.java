...
import jensdev.lifeline.sensorOutput2;
        ...
        public void onReceive(Context context, final Intent intent)
        {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action))
            {
                ...
                if(device.getAddress().equals(mspAddress1) || device.getAddress().equals(mspAddress2))
                {
                    ...
                    listView2.setAdapter(new ArrayAdapter<>(context, android.R.layout.simple_list_item_1, mDeviceList));
                }
                ...
                listView2.setOnItemClickListener(new AdapterView.OnItemClickListener()
                {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), sensorOutput2.class);
